...
class MoveBaseClient:
    ...
    def movebase_client(self, x):
        ...
        if x == 1:
            goal.target_pose.pose.position.x = 1.270
            goal.target_pose.pose.position.y = 0.000
            goal.target_pose.pose.orientation.z = 0.700
            ...
            goal.target_pose.pose.position.x = 2.12
            ...
            goal.target_pose.pose.orientation.z = 2.200
            goal.target_pose.pose.orientation.w = 1.000
